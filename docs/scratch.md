...
Event
    toggleView() ~ swap class
        setSVGView() ~ check current class
            apply svgType props

    note: caching node className on nodeToggle() will reverse
          the setSVGView() applied props due to event sequence
...
<!--
<div class="new-branch add-last-branch js-add-root">
    <div class="add-child-angled">
...
<!--
<div class="new-branch add-child-branch">
    <div class="dashed-line-h"></div>
    <img inline src="~jam-icons/svg/plus-circle-f.svg">
    <img inline src="~jam-icons/svg/close.svg">
</div>
-->
...
<!--
<div class="new-branch add-sibling-branch js-add-sibling ">
...
# Sibling Btn - Vertical Only

<!--
<div class="new-branch add-test-branch js-add-sibling">
    <div class="dashed-line-v"></div>
    <svg xmlns="http://www.w3.org/2000/svg" class="jam jam-plus-circle-f" preserveAspectRatio="xMinYMin" viewBox="-2 -2 24 24">
        <path d="M11 11h4a1 1 0 0 0 0-2h-4V5a1 1 0 0 0-2 0v4H5a1 1 0 1 0 0 2h4v4a1 1 0 0 0 2 0v-4zm-1 9C4.477 20 0 15.523 0 10S4.477 0 10 0s10 4.477 10 10-4.477 10-10 10z"></path>
    </svg>
